...
import { ILINK_BASE_URL, ITEM_FILE, ITEM_IMAGE, ITEM_TEXT, ITEM_VIDEO, MESSAGE_TYPE_USER, RATE_LIMIT_ERRCODE, SESSION_EXPIRED_ERRCODE, UPLOAD_MEDIA_FILE, UPLOAD_MEDIA_IMAGE, } from "./types.js";
import { downloadImage as downloadImageMedia } from "./media.js";
import { aesEcbPaddedSize, encodeMediaAesKey, md5Hex, randomHex, uploadBufferToCdn, UPLOAD_MAX_BYTES } from "./upload.js";
    ...
    async uploadAndSendMedia(params) {
        ...
        try {
            ...
            if (slot.ret && slot.ret !== 0) {
                const result = { ok: false, ret: slot.ret, errcode: slot.errcode, errmsg: slot.errmsg };
            ...
            const item = params.mediaType === UPLOAD_MEDIA_IMAGE
            ...
            const record = { ok: false, errmsg: err instanceof Error ? err.message : String(err) };
