...
export function sanitizeState(value) {
    const base = { version: 1, peerPrefs: {}, pairedUserIds: [], peerSessions: {}, sessionOwners: {}, contextTokens: {} };
    ...
    if (Array.isArray(rawPaired)) {
        for (const id of rawPaired) {
            if (typeof id === 'string' && id && !pairedUserIds.includes(id))
...
export class BridgeState {
    ...
    constructor(opts = {}) {
        ...
        let loaded = { version: 1, peerPrefs: {}, pairedUserIds: [], peerSessions: {}, sessionOwners: {}, contextTokens: {} };
        try {
