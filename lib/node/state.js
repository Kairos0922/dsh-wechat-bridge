...
export function sanitizeState(value) {
    ...
    if (typeof rawAccess === 'object' && rawAccess !== null) {
        for (const [session, enabled] of Object.entries(rawAccess)) {
            if (isSessionId(session) && typeof enabled === 'boolean')
                sessionAccess[session] = enabled;
        }
    }
...
export class BridgeState {
    ...
    isSessionAccessEnabled(sessionId) {
        return this.sessionAccess.get(sessionId) === true;
    }
    setSessionAccess(sessionId, enabled) {
